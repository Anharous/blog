...
export default function Home() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = document.querySelectorAll('.details-left h2');
      const sidebarLinks = document.querySelectorAll('.side-bar p');
      let currentIndex = 0;
    ...
    const detailsLeft = detailsLeftRef.current;
  ...
  return (
    <div className="whole-container">
      <div className="sub-whole-container">
        <div className="details-left" ref={detailsLeftRef}>
          <div className="details-one">
            <h4 className="insurance">Insurance</h4>
            <h2 id="section-1">Expert raises $13 billion global private equity fund</h2>
          ...
          <div className="traslation-container">
            <h2 id="section-2">1914 translation by H. Rackham</h2>
